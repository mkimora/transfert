...
return [
    ...
    'app_partenaire_show' => [[], ['_controller' => 'App\\Controller\\PartenaireController::show'], [], [['text', '/api/patenaires']], [], []],
    'add' => [[], ['_controller' => 'App\\Controller\\PartenaireController::register'], [], [['text', '/api/addP']], [], []],
    'update_par' => [['id'], ['_controller' => 'App\\Controller\\PartenaireController::depot'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/api/depot']], [], []],
